...
# Project title ####
MY_TITLE <- "Differentially expressed proteins in _Arabidopsis_ between controls in WT and mutants _rbohC_ and _rbohF_"

# Proteomics data files ####
# ctrl samples
FILE_rbohF_vs_WT <- "data/rbohF_C_vs_WT_C_filt.tsv"
FILE_rbohC_vs_WT <- "data/rbohC_C_vs_WT_C_filt.tsv"
FILE_rbohF_vs_rbohC <- "data/rbohF_C_vs_rbohC_C_filt.tsv"
# Cd samples
...
# Subcellular location data file ####
...
# path to Rmd ####
render(input = paste0(SOURCE_DIR, "/", "analysis_WTvsMutant.Rmd"),
       output_dir = SUB_DIR,
